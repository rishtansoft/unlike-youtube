...
*   **Process stopped?** try checking if the language is supported or reload the page.
*   **Icon not showing?** Remove the extension and load it again to refresh the cache.
...
---
*Created by [Ibrohimjon25](https://github.com/Ibrohimjon25)*
